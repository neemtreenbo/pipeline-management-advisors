    ...
    return (
        <>
            ...
            <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 pointer-events-none">
                <div className="bg-card rounded-2xl shadow-[0_16px_48px_-12px_rgba(0,0,0,0.18)] w-full max-w-xl flex flex-col overflow-hidden border border-border pointer-events-auto">
